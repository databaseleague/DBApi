...
if [ "$command" = "standalone" ]; then
  ...
  generate_classpath
  CLASS=com.gitee.freakchicken.dbapi.C_jvGWFEdS
  ...
  exclude_jars=("spring-boot-starter-webflux" "spring-webflux" "spring-cloud-gateway-server" "spring-cloud-starter-gateway")
  generate_classpath
  CLASS=com.gitee.freakchicken.dbapi.manager.C_uNdnCUko
  ...
  exclude_jars=("spring-boot-starter-webflux" "spring-webflux" "spring-cloud-gateway-server" "spring-cloud-starter-gateway")
  generate_classpath
  CLASS=com.gitee.freakchicken.dbapi.apiserver.C_pshlvG5j
  HEAP_OPTS="-Xms4g -Xmx4g -Xmn2g"
  ...
  generate_classpath
  CLASS=com.gitee.freakchicken.dbapi.gateway.C_jzIn1WWy
  HEAP_OPTS="-Xms4g -Xmx4g -Xmn2g"
